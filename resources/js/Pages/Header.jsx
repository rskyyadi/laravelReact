...
export default function Header(props) {
    ...
    const RegisterButton = () => (
        <a className='ml-3' href={route('register')}>
            <button 
                type="button" 
                className="flex items-center text-blue-600 bg-blue-700 
                    hover:bg-blue-800 focus:ring-4 focus:outline-none 
                    focus:ring-blue-300 font-medium text-sm 
                    px-4 py-3 text-center mr-3 md:mr-0 dark:bg-white 
                    dark:hover:bg-blue-700 dark:focus:ring-blue-800
                    font-semibold rounded"
                >
                <IoLogIn className='mr-2' />
    ...
    const SocialIcons = () => (
        <div className='text-white flex'>
            ...
            <a className='ml-3' href='http://www.instagram.com'><FaInstagram /></a>
        </div>
    )
    return (
        <> 
            <nav className="transparent dark:transparent fixed w-full z-20 top-0 left-0 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="https://flowbite.com/" className="flex items-center">
                        <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="Flowbite Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Kembar Sari Bali</span>
                    </a>
